                ...
                <div class="card-body">
                    <form @submit.prevent="save">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input autofocus type="datetime-local" v-model="fecha_publicacion" required class="form-control">
                        </div>
                        <label>
...
methods: {
    async save() {
        this.loading = true;
        try {
            const response = await this.$axios.post("http://127.0.0.1:8000/api/peliculas", {
                nombre: this.nombre,
