    ...
    <div class="row">
      <div class="col-md-4 offset-md-4">
        <div class="d-grid col-10 mx-auto">
            ...
            <router-link class="btn btn-dark" :to="{ path: 'addTurno'}">Agregar un turno</router-link>
        </div>
      </div>
    </div>
    <table class="table">
        ...
        <tbody>
            ...
            <td> 
              <div class="row">
                <div class="col-md-4">
                  <router-link class="btn btn-primary" :to="{ path: 'editTurno/' + turno.id}"><span><i class="fa-solid fa-pen-to-square"></i></span></router-link>
                </div>
                <div class="col-md-4">
                  <button class="btn btn-danger" @click="deleteTurno(turno.id)"><span><i class="fa-solid fa-trash-can"></i></span></button>
                </div>
              </div>
            </td>
            </tr>
  ...
  export default {
    ...
    methods:{
      ...
      async deleteTurno(id){
          try {
              const response = await this.$axios.delete("http://127.0.0.1:8000/api/turno/" + id, {
              });
          } catch (error) {
